...
class GeoViewer {
    ...
    constructor(canvasId = "vacanvas", center = undefined, zf = 1) {
        ...
        let t_ = d3_zoom__WEBPACK_IMPORTED_MODULE_0__["zoomIdentity"]
        zoom.on("zoom", (e) => {
            //console.log(e)
            const t = e.transform
            const f = t_.k / t.k
