...
class GridViz {
    ...
    constructor(opts) {
        ...
        Object(d3_fetch__WEBPACK_IMPORTED_MODULE_1__["json"])("https://raw.githubusercontent.com/eurostat/gridviz/master/assets/csv/Europe/grid_pop_tiled/1km/info.json").then((data) => {
            gridInfo = data;
            th.cplus.redraw()
        });
