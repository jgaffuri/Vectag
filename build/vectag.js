...
class UrbanSimulation {
    ...
    initRandom(nb = 100) {
        ...
        this.map.bs = [];
        for (let i = 0; i < nb; i++) {
            this.map.bs.push(new _Building__WEBPACK_IMPORTED_MODULE_1__["Building"](this.map, this.map.w * Math.random(), this.map.h * Math.random()))
        }
        return this;
    }
