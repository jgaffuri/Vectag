...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'jsts'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
class RoadNetwork {
    ...
    constructor(map) {
        ...
        var reader = new !(function webpackMissingModule() { var e = new Error("Cannot find module 'jsts'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).io.WKTReader()
